  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <View style={styles.container}>
        ...
        <FontAwesome.Button testID="speakNormalButton2"  name="volume-up" backgroundColor="#450101" onPress={handleButtonPress} style={styles.b1}>
          Speak Normal
        </FontAwesome.Button>
        <FontAwesome.Button name="volume-up" backgroundColor="#450101" onPress={handleSlowSpeech} style={styles.b1}>
          Speak Slow
        </FontAwesome.Button>
      </View>
    );
