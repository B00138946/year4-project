...
import data from '../Data/dataWordsGameTod';
...
const WordsGameTod = () => {
  ...
  const handleNextClick = () => {
    ...
    if (nextQuestion < shuffledData.length) {
      ...
      navigation.navigate('score', { score: scoreRef.current, totalQuestions: shuffledData.length, screenName: 'Toddler Word Game', });
    }
  };
