...
import data from '../Data/dataWordsGamePre';
...
const WordsGamePre = () => {
  ...
  const handleNextClick = () => {
    ...
    if (nextQuestion < shuffledData.length) {
      ...
      navigation.navigate('score', { score: scoreRef.current, totalQuestions: shuffledData.length, screenName: 'Pre-Schooler Word Game', });
    }
  };
  ...
  return (
    ...
    >
      <View style={styles.container}>
        <Text style={styles.headerText}>WordsGameTod Click the correct Sound</Text>
