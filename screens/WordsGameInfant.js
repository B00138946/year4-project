...
import data from '../Data/dataWordsGame';

const WordsGameInfant = () => {
  ...
  const handleNextClick = () => {
    ...
    if (nextQuestion < shuffledData.length) {
      ...
      navigation.navigate('score', { score: scoreRef.current, totalQuestions: shuffledData.length, screenName: 'Infant Word Game', });
    }
  };
...
export default WordsGameInfant;
